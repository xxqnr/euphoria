--[[
    ...
    [ xxqnr ] - [ @1317200525174767706 ] | Only developer
    [ William ] - [ @889245601009647616 ] | Used His Martians Army's To Conquer Phantom's AntiCheat

    ~ Special Thanks ~

    [ xxqnr ] - [ Owner ]
    [ William ] - [ Leader Of Alien's ]
...
workspace:FindFirstChild("n word stop deobfuscating my script you black monkey nigger - xxqnr") -- there (@723741691583922209_
do -- Drawing Library 
    local drawing = {}
    local cache = {
        updates = {},
...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    if not isfolder(folderName .. "/sounds") then
        ...
        task.delay(1, function()
            for name, link in {
                ["sigma boy"] = "https://www.myinstants.com/media/sounds/sigma-boy.mp3",
